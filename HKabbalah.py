...
def interpret_revelation(question: str, sephirot_list: List[str], model: str) -> str:
    ...
    if len(sephirot_list) == 10:
        ...
        tree_of_life_map = {sephirah.split(' ')[0]: sephirah for sephirah in sephirot}
        positions = [
        ...
        sephirot_text = ", ".join(sephirot_list)
...
def main():
    ...
    if count == 10:
        # For a full tree reading, we show all sephirot in their proper order
        for sephirah in sephirot:
