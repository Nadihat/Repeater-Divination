...
# === LATIN WORD LIST ===
words = [
    'amor', 'aqua', 'caput', 'corpus', 'dux', 'epistula', 'frater', 'ignis', 'labor', 'lex', 'lux', 'manus',
    'mater', 'miles', 'mons', 'nox', 'pater', 'pax', 'rex', 'terra', 'urbs', 'verbum', 'vir', 'vita', 'ago',
    'audio', 'capio', 'credo', 'dico', 'do', 'dormio', 'duco', 'facio', 'habeo', 'mitto', 'pono', 'scio',
    'scribo', 'sentio', 'venio', 'video', 'vinco', 'bonus', 'brevis', 'celer', 'communis', 'gravis',
    'magnus', 'malus', 'multus', 'omnis', 'solus', 'bene', 'celeriter', 'cur', 'etiam', 'hic', 'ibi', 'ita',
    'non', 'nunc', 'saepe', 'semper', 'sic', 'ubi', 'a', 'ab', 'ad', 'cum', 'de', 'e', 'ex', 'in', 'per',
    'pro', 'sine', 'sub', 'aut', 'enim', 'et', 'que', 'quod', 'sed', 'si', 'ego', 'hic', 'haec', 'hoc',
    'idem', 'eadem', 'ille', 'illa', 'illud', 'is', 'ea', 'id', 'qui', 'quae', 'tu',
    'abbas', 'acies', 'aedificium', 'aetas', 'ager', 'arbor', 'argentum', 'arma', 'ars', 'aurum', 'basium',
    'bellum', 'benevolentia', 'caelum', 'calamitas', 'campana', 'carmen', 'causa', 'civis', 'civitas',
    'commissum', 'delectatio', 'dominus', 'domus', 'ecclesia', 'episcopus', 'eventus', 'famulus', 'fides',
    'flamma', 'frigus', 'gladius', 'homo', 'hostis', 'imperium', 'ira', 'iter', 'ius', 'lapis', 'liber',
    'locus', 'mare', 'modus', 'mors', 'mulier', 'nomen', 'numerus', 'oculus', 'opus', 'pars', 'pes',
    'poena', 'pons', 'populus', 'porta', 'res', 'sanguis', 'scelus', 'schola', 'sedes', 'servus', 'spes',
    'telum', 'tempus', 'timor', 'via', 'virtus', 'vox', 'aio', 'amo', 'bibo', 'cado', 'cano', 'cognosco',
    'curro', 'doceo', 'eo', 'fero', 'fugio', 'gero', 'intro', 'iubeo', 'lego', 'maneo', 'moveo', 'pello',
    'peto', 'possum', 'pugno', 'quaero', 'relinquo', 'respondeo', 'rideo', 'sequor', 'sto', 'sum', 'teneo',
    'vivo', 'voco', 'volo', 'acer', 'aeternus', 'alius', 'alter', 'altus', 'certus', 'clarus', 'difficilis',
    'dulcis', 'facilis', 'felix', 'fortis', 'longus', 'meus', 'miser', 'noster', 'novus', 'nullus', 'parvus',
    'pauci', 'pulcher', 'sacer', 'suus', 'tardus', 'totus', 'tristis', 'tuus', 'vester', 'diu', 'male',
    'numquam', 'olim', 'tam', 'tum', 'ante', 'apud', 'circum', 'contra', 'inter', 'post', 'propter', 'super',
    'trans', 'at', 'igitur', 'nam', 'nec', 'neque', 'ut', 'vel', 'ipse', 'ipsa', 'ipsum', 'nos', 'quis',
    'quid', 'se', 'vos'
]
DECK_SIZE = len(words)
...
def interpret_reading(question: str, word_list: List[str], model: str) -> str:
    ...
    system_prompt = (
        "You are a Latin scholar. Interpret the drawn words in a poetic and insightful way, "
        "connecting them to the user's question. Provide a simple, clear, and helpful message."
    )
    user_prompt = (
        f"The question is: '{question}'\n\n"
        f"The following Latin word(s) were drawn:\n{word_text}"
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Get a Latin reading using an LLM via OpenRouter.",
    ...
    console.print("[bold cyan]Latin Oracle[/bold cyan] (via OpenRouter)")
