...
Interactive multi-card selection via a spinning wheel of hashes.
"""
...
class TarotApp:
    ...
    def run_interactive(self):
        ...
        print(f"\nThe deck is ready. Press Enter to select {num_cards} cards.")
        ...
        try:
            ...
            for i in range(num_cards):
                print(f"\nSpinning for card #{i+1}... Press Enter to stop.")
                ...
                while True:
                    ...
                    sys.stdout.write(f"> {current_hash} <")
                    sys.stdout.flush()
                ...
                available_hashes.remove(chosen_hash) # Ensure card is not drawn again
